...
export function initializeScheduler() {
  ...
  try {
    ...
    console.log('    • Catalysts: FREE (AlphaVantage NEWS_SENTIMENT)');
    console.log('    • Analyst activity: FREE (AlphaVantage NEWS_SENTIMENT)');
    console.log('    • Operational risks: FREE (AlphaVantage NEWS_SENTIMENT)');
    console.log('    • SEC filings: ~2 credits (Tavily only)');
    console.log('    • General news: ~1 credit (Tavily basic search)');
    ...
    console.log('  - Auto post-mortems: ~3-5 credits per closed trade');
    console.log('  - Weekly enrichment: ~4-6 credits per symbol');
    console.log('  - Smart filtering: Skips 60-70% of trades (IPS > 75, DTE > 14, no alerts)');
